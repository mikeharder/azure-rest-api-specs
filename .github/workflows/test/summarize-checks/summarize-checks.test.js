  ...
  describe("check result processing", () => {
    it("should generate success summary for no matched check suites (completed impactAssessment)", async () => {
      ...
      const expectedOutput = [
        '<h2>Next Steps to Merge</h2>✅ All automated merging requirements have been met! To get your PR merged, see <a href="https://aka.ms/azsdk/specreview/merge">aka.ms/azsdk/specreview/merge</a>.<br />Comment generated by <a href="http://github.com/a/fake/workflowrun/url">summarize-checks</a> workflow run.',
        {
    ...
    it("should generate pending summary when checks are partially in progress", async () => {
      ...
      const fyiCheckRuns = [];
      const expectedOutput = [
        `<h2>Next Steps to Merge</h2>⌛ Please wait. Next steps to merge this PR are being evaluated by automation. ⌛<br />Comment generated by <a href="http://github.com/a/fake/workflowrun/url">summarize-checks</a> workflow run.`,
        {
          name: "Automated merging requirements met",
          result: "pending",
    ...
    it("should generate pending summary when impact assessment is not completed", async () => {
      ...
      const fyiCheckRuns = [];
      const expectedOutput = [
        `<h2>Next Steps to Merge</h2>⌛ Please wait. Next steps to merge this PR are being evaluated by automation. ⌛<br />Comment generated by <a href="${WORKFLOW_URL}">summarize-checks</a> workflow run.`,
        {
          name: "Automated merging requirements met",
          result: "pending",
          summary: "The requirements for merging this PR are still being evaluated. Please wait.",
    ...
    it("should generate pending summary when checks there are no required checks blocking or completed, but successful FYI checks", async () => {
      ...
      const expectedOutput = [
        `<h2>Next Steps to Merge</h2>Important checks have failed. As of today they are not blocking this PR, but in near future they may.<br/>Addressing the following failures is highly recommended:<br/><ul><li>⚠️ The check named <code>Swagger LintDiff</code> has failed. Refer to the check in the PR's 'Checks' tab for details on how to fix it and consult the <a href="https://aka.ms/ci-fix">aka.ms/ci-fix</a> guide</li></ul><br />Comment generated by <a href="http://github.com/a/fake/workflowrun/url">summarize-checks</a> workflow run.`,
        {
          name: "Automated merging requirements met",
          result: "pending",
          summary: "The requirements for merging this PR are still being evaluated. Please wait.",
    ...
    it("Should generate error summary for a PR scenario where NotReadyForARMReview is present", async () => {
      ...
      const expectedComment =
        ...
        `aka.ms/brch</a>.</li></ul><br />Comment generated by <a href="http://github.com/a/fake/workflowrun/url">summarize-checks</a> workflow run.`;
    ...
    it("Should generate error summary for a PR scenario with labeling issues", async () => {
      ...
      const expectedComment =
        ...
        'the <a href="https://aka.ms/ci-fix">aka.ms/ci-fix</a> guide</li></ul><br />Comment generated by <a href="http://github.com/a/fake/workflowrun/url">summarize-checks</a> workflow run.';
      const expectedOutput = [
        expectedComment,
        {
          name: "Automated merging requirements met",
